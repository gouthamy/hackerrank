...
public class MarsExploration {
	public static final int SOS_LENGTH = 3;
	public static void main(String[] args) {
		Scanner in = new Scanner(System.in);
		String S = in.next().toUpperCase();
		int noOfSOSWords = S.length()/SOS_LENGTH;
		int noOfChangedLetters = 0;
		int index = 0 ;
		for(int word = 1; word <= noOfSOSWords; word++){
		...
		System.out.println(noOfChangedLetters);
	}
}
